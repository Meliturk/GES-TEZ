...
print("GES AI + Spark + Spark SQL + Hadoop Data Lake proje akisi baslatildi...\n")
...
print("=" * 60)
print("Tum GES AI + Spark + Spark SQL + Hadoop Data Lake proje akisi basariyla tamamlandi.")
print("=" * 60)
